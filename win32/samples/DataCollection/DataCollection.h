//------------------------------------------------------------------------------
// <copyright file="DataCollection.h" company="Microsoft">
...
#define WM_USER_UPDATE_TIME              WM_USER
...
private:
    HWND                    m_hWnd;
	TCHAR                   statusmsg[cStatusMessageMaxLen];
   // bool                    m_bSaveScreenshot;
	//bool                    m_bNearMode;
	//bool                    m_bSeatedMode;
	//bool                    m_bSaveSkeleton;
	bool                    m_bSaveSkeStart;
	bool                    m_bSaveSkeStop;
	bool                    m_bIsInDelay;
	int                     m_iDelayTime;
	int                     m_iRecordingModeIndex;
	int                     m_iFrameConstraint;
	DWORD                   m_dwTimeConstraint;
	DWORD                   starttime;
	DWORD                   currenttime;
	...
	HANDLE                  hskf;
	TCHAR                   skefname[MAX_PATH];
	TCHAR                   m_SkeFilePath[MAX_PATH];
	 //BYTE*                   m_depthRGBX;
    /// <summary>
	...
	bool                    SaveOneSkeleton(HANDLE hFile,Vector4 *skepoints);

	bool                    SaveSkeletonHeader(HANDLE hFile);
    /// <summary>
